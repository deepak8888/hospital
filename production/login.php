              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" id="log" class="form-horizontal form-label-left" action="actionpages/login_action.php">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="username" placeholder=""  type="text">
                        </div>
                      </div>
					  <div class="item form-group">
