        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>CHANNEL WORLD</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="reg.php"><i class="fa fa-user"></i> Sign-Up </a>
                    
                  </li>
				   <li><a href="index.php"><i class="fa fa-unlock"></i> Login </a>
                    
                  </li>
				  <li><a href="contact.php"><i class="fa fa-phone"></i> Contact Us </a>
                    
                  </li>
				   <li><a href="about.php"><i class="fa fa-info-circle"></i> About us </a>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Locality <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
