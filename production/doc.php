...
<html lang="en">
  ...
  <body class="nav-md">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
							...
							<th class="column-title">Upload Certificate </th>
	...
	$query="SELECT name, address, email, phone, photo, username, password, gender, qualification, specialization, certificate, status,doctor_id FROM doctor_registration";
...
?>
      ...
      <td><img src="doctor_photo/<?php echo $arr[4];?>" height="100" width="100"/></td>
      ...
      <td><a href="change_doctor_status.php?docid=<?php echo $arr[12];?>"><?php echo $arr[11];?></a></td>
                          </tr>
						  <?php
	}
	?>
