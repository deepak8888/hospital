        ...
        <div class="right_col" role="main">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left"  id="docregistration" method="post" enctype="multipart/form-data" >
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea"> Consultation Venue <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="textarea"  name="venue" class="form-control col-md-7 col-xs-12"></textarea>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="file" name="photo" data-validate-linked="photo" required class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                     
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="select">Specialisation <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <option value="Neurologist ">Neurologist </option>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="file" name="certificate"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="username"   type="text">
                        </div>
                      </div>
                      <div class="item form-group">
					  ...
					  <div class="item form-group">
                        ...
                        <input type="radio" class="flat" name="gender" id="genderM"  value="female" checked /> Female
                        <input type="radio" class="flat" name="gender" id="genderF" value="male" />Male
...
if(isset ($_POST['submit']))
{
	...
	$query="INSERT INTO doctor_registration( name, address, email, phone, photo, username, password, gender, qualification, specialization, certificate,status,venue) VALUES ('$name','$address','$email','$phone','$photo','$username','$password','$gender','$qualification','$specialization','$certificate','disable','$venue')";
...
<script src="validation/docrregvalidation.js"></script>
    <!-- /validator -->
  </body>
</html>