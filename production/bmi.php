              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" id="bmi" class="form-horizontal form-label-left" >

                      

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Your Height(in cm): <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="height" placeholder=""  type="number" required>
                        </div>
                      </div>
					  <div class="item form-group">
                        <label for="password" class="control-label col-md-3">Your Weight:</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="weight" type="number" name="weight"  class="form-control col-md-7 col-xs-12" required >
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button type="reset" class="btn btn-primary">Cancel</button>
                           <input  name="submit" id="send" type="submit" class="btn btn-success" value="COMPUTE BMI">
                        </div>
                      </div>
                    </form>
					<br/>
    ...
    if($bmi<=18.5)
{
 echo "<script type=\"text/javascript\">".
        "alert('Your Bmi:$bmi .Under Weight');".
        "</script>";}
elseif($bmi>18.5 && $bmi<=24.9)
{
 echo "<script type=\"text/javascript\">".
        "alert('Your Bmi:$bmi.Normal');".
        "</script>";}
elseif($bmi>=25 && $bmi<=29.9)
{
 echo "<script type=\"text/javascript\">".
        "alert('Your Bmi:$bmi.Over Weight');".
        "</script>";}
else
{
 echo "<script type=\"text/javascript\">".
        "alert('Your Bmi:$bmi.Obesity');".
        "</script>";}
		}
	?>
